...
// 3.4028234e38 rounds to <= f32::MAX; the rounder 3.4028235e38 literal rounds
// ABOVE max and Dawn/Tint rejects it (wgpu-native/Naga accepts it).
const REAL_MAX: f32 = 3.4028234e+38;
const REAL_MIN: f32 = -3.4028234e+38;
